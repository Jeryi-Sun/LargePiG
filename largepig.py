...
class largepig:
    ...
    def generate(self, input_text, max_new_tokens=256, top_p=0.95, top_k=0, temperature=0.8, mature_layer=None, premature_layer=None, candidate_premature_layers=[], mode='baseline', verbose=True, remove_stop_words=False, relative_top=0.1, pointer=False, only_pointer=False, 
        ...
        with torch.no_grad():
            ...
            if mode == 'baseline':
                ...
                outputs = self.model.generate(input_ids, max_length=max_len, num_return_sequences=1,
                                        ...
                                        mature_layer=mature_layer, premature_layer=premature_layer, candidate_premature_layers=candidate_premature_layers, 
                ...
                outputs = self.model.generate(input_ids, max_length=max_len, num_return_sequences=1,
                                        ...
                                        candidate_premature_layers=candidate_premature_layers,generation_config=generation_config, **kwargs,)
                premature_layer_dist = outputs.premature_layer_dist
